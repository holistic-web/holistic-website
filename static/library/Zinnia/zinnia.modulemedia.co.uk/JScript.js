...
$(document).ready(function () { // dom loaded
  ...
  //  $('#myaccounttabs .etabs').insertAfter('#homeslider');
   ...
   // initScrollClick();
    ...
    aboutTextSlider = $('.aboutText').bxSlider({
        mode : 'fade',
        controls: false,
        pager: true,
        infiniteLoop: false,
...
function goSlide(el)
{
    aboutTextSlider.goToSlide(el);
    $('.theNames a').removeClass('selected');
    $('.theNames a.selMe' + el).addClass('selected');
}
...
function ShowModal(id) {
    ...
    function SubmitContactForm() {
        if ($('#Name').val() != "" && $('#Company').val() != "" && $('#Email').val() != "" && $('#Query').val() != "") {
